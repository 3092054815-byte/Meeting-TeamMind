# MeetingBrain - AI-Powered Team Knowledge Memory
...
MeetingBrain splits knowledge work across focused agents instead of relying on one large prompt for every task.
...
MeetingBrain is designed for both natural-language Q&A and relationship-aware reasoning, such as "which tasks were affected by this decision?"
...
```bash
git clone https://github.com/3092054815-byte/MeetingBrain.git
cd MeetingBrain
...
MeetingBrain includes a minimal FastAPI entrypoint:
...
- GitHub Issues: https://github.com/3092054815-byte/MeetingBrain/issues
